...
class Safety(unittest.TestCase):
 ...
 def test_compile(self):
  questions=[{'_source':'zhenti','_id':str(i),'stem':'验证题。已知 $A=\\begin{bmatrix}1&2\\\\3&4\\end{bmatrix}$，请判断 $2^{10}$ 的值。','options':{'A':'1024','B':'2048','C':'4096','D':'8192'}} for i in range(1,21)]
