...
const css=document.createElement('link');css.rel='stylesheet';css.href='/assets/css/question-bank-switch.css?v=20260824-graph4';document.head.appendChild(css);
...
if(current==='relax1000'){
  import('/assets/js/relax1000-graph.js?v=20260824-graph45-3').catch(error=>{
    ...
    fail.innerHTML='<section><h1>Relax1000 图谱载入失败</h1><p>图谱数据暂时没有完整载入，请刷新后重试。</p></section>';
    shell.after(fail);
  });
}
