...
css.rel='stylesheet';css.href='/assets/css/question-bank-switch.css?v=20260824-bank11';document.head.appendChild(css);
...
if(current==='relax1000'){
  const controls=document.createElement('link');controls.rel='stylesheet';controls.href='/assets/css/relax1000-controls.css?v=20260824-relax11';document.head.appendChild(controls);
  import('/assets/js/relax1000-wall.js?v=20260824-bankwall3')
    .then(()=>import('/assets/js/relax1000-cards.js?v=20260824-cards3'))
    .then(()=>Promise.all([
      import('/assets/js/relax1000-reset.js?v=20260824-relax11'),
      import('/assets/js/relax1000-cards-experience.js?v=20260824-relax11')
    ]))
    .catch(error=>{
      ...
      fail.innerHTML='<section><h1>Relax1000 载入失败</h1><p>没有成功读取题库模块。刷新后仍失败时，请检查题源连接。</p></section>';
      shell.after(fail);
    });
}
