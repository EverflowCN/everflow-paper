(()=>{
  ...
  const supplementYears=new Set(['2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025','2026']);
  const cache=new Map();
  ...
  async function loadSupplement(year){
    ...
    const p=nativeFetch(`/data/zhenti/supplement/${year}.json?v=20260824c`,{cache:'no-store'})
