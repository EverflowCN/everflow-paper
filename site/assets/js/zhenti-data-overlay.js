(()=>{
  ...
  const DATA_VERSION='20260824-full1';
  ...
  function mergeQuestionSets(base,supplement,extra){
    const merged={};
    // Precedence is intentional: base < supplement < extra.
    // Later verified patches must be able to replace stale/unverified base data,
    // while extra keeps the highest priority for exact figure-backed corrections.
