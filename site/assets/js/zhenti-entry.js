...
const runtime=import('/assets/js/site-runtime-v2.js?v=20260922-syncguard4');
...
if(source==='zhenti'){
  ...
  await import('/assets/js/zhenti-wall.js?v=20260922-syncguard4');
}
await runtime;
if(mathMode){
  ...
  await import('/assets/js/question-cloud-sync-v2.js?v=20260922-syncguard4');
